...
export class EnterPinComponent implements OnInit {
  ...
  submitted: boolean;
  disableEnteredPin: { 'inputType': string, 'disable': boolean } = { 'inputType': 'old', 'disable': false };
  ...
  get formErr(){ return this.enterpinGroup.controls}
  fnValidatePin() {
  ...
  fnForgetPin() {
    this.globalService.showConfirmationAlertPrompt("Reset PIN", "Do you want to reset PIN");
  }
}
